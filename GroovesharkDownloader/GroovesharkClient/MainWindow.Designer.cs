namespace GroovesharkPlayer
{
    partial class MainWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.playerControl = new GroovesharkPlayer.Controls.QueueControl();
            this.playlistControl = new GroovesharkPlayer.UserPlaylistControl();
            this.popularControl = new GroovesharkPlayer.Controls.PopularControl();
            this.searchControl = new GroovesharkPlayer.SearchControl();
            this.settings = new GroovesharkPlayer.Controls.SettingsControl();
            this.cacheControl = new GroovesharkPlayer.Controls.CacheControl();
